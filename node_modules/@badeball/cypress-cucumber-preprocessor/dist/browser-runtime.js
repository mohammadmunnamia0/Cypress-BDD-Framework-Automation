...
const browser_1 = require("./helpers/expose/browser");
const expose_1 = require("./helpers/expose/expose");
...
function retrieveInternalSpecProperties() {
    return (0, browser_1.getInternalValue)(constants_1.INTERNAL_SPEC_PROPERTIES);
}
...
function retrieveInternalSuiteProperties() {
    return (0, browser_1.getInternalValue)(constants_1.INTERNAL_SUITE_PROPERTIES);
}
...
function createPickle(context, pickle) {
    ...
    if ((0, expose_1.determineConfigurationEra)() === expose_1.ConfigurationEra.Env) {
        ...
        delete inheritedTestOptions["env"];
        if (inheritedTestOptions.expose) {
            Object.assign(inheritedTestOptions.expose, internalEnv);
        }
        else {
            inheritedTestOptions.expose = internalEnv;
        }
    }
    it(scenarioName, inheritedTestOptions, function () {
        ...
        taskTestCaseStarted(context, {
            id: testCaseStartedId,
            testCaseId,
            attempt: this.test._currentRetry,
...
function createTestFilter(gherkinDocument) {
    ...
    if (tagsInDocument.includes("@only") || tagsInDocument.includes("@focus")) {
        ...
        const tags = (0, browser_1.getInternalValue)("tags");
    ...
    registry.resolveBeforeAllHooks().reduce((chain, hook) => {
        return chain.then(() => {
            ...
            taskRunHookStarted(context, {
                ...
                hookId: hook.id,
                testRunStartedId: (0, assertions_1.ensure)((0, browser_1.getInternalValue)("testRunStartedId"), "Expected to find a testRunStartedId"),
                timestamp: start,
            });
...
function createTests(registry, seed, source, gherkinDocument, pickles, isTrackingState, omitFiltered, stepDefinitionHints, dryRun) {
