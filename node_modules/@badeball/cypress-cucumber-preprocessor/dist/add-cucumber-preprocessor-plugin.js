...
async function addCucumberPreprocessorPlugin(on, config, options = {}) {
    ...
    env[constants_1.INTERNAL_SUITE_PROPERTIES] = { isEventHandlersAttached: true };
    ...
    on("task", {
        ...
        [cypress_task_definitions_1.TASK_TEST_RUN_HOOK_STARTED]: plugin_event_handlers_1.testRunHookStartedHandler.bind(null, config),
        [cypress_task_definitions_1.TASK_TEST_RUN_HOOK_FINISHED]: plugin_event_handlers_1.testRunHookFinishedHandler.bind(null, config),
        ...
        [cypress_task_definitions_1.TASK_SUGGESTION]: plugin_event_handlers_1.suggestion.bind(null, config),
    });
    const tags = env.tags;
    if (tags != null && preprocessor.filterSpecs) {
        ...
        const testFiles = (0, find_cypress_specs_1.getSpecs)(config, "foobar", true).filter((testFile) => {
            ...
            const content = node_fs_1.default.readFileSync(testFile).toString("utf-8");
            const options = {
                includeSource: false,
    ...
    env.testRunStartedId = (0, uuid_1.v4)();
    return config;
}
